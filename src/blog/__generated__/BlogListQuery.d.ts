...
export interface BlogListQuery_allMdx_edges_node_frontmatter_authorImage_childImageSharp_fluid {
  base64: string | null;
  aspectRatio: number;
  src: string;
  srcSet: string;
...
export interface BlogListQuery_allMdx_edges_node_frontmatter_authorImage_childImageSharp {
  fluid: BlogListQuery_allMdx_edges_node_frontmatter_authorImage_childImageSharp_fluid | null;
}

export interface BlogListQuery_allMdx_edges_node_frontmatter_authorImage {
  childImageSharp: BlogListQuery_allMdx_edges_node_frontmatter_authorImage_childImageSharp | null;
}
...
export interface BlogListQuery_allMdx_edges_node_frontmatter {
  ...
  author: string | null;
  date: any | null;
  authorImage: BlogListQuery_allMdx_edges_node_frontmatter_authorImage | null;
