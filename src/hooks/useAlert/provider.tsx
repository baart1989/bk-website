...
//   position: PropTypes.oneOf(Object.keys(positions).map(position => positions[position])),
//   timeout: PropTypes.number,
//   type: PropTypes.oneOf(Object.keys(types).map(type => types[type])),
//   transition: PropTypes.oneOf(Object.keys(transitions).map(transition => transitions[transition])),
//   containerStyle: PropTypes.object,
//   template: PropTypes.oneOfType([PropTypes.element, PropTypes.func, PropTypes.elementType])
//     .isRequired,
